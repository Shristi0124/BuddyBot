...
async def update_chat(
    ...
    # For now, return a dummy bot reply
    bot_reply = f"You said: {question}"
...
from llm.prescription import Model, get_predict_percentage_stroke, get_predict_percentage_diabetes, get_predict_percentage_cancer, get_predict_percentage_asthma
